...
<!-- Header and Nav -->
  ...
  <div class="row">
    <div class="twelve columns">
      <div class="panel">
        <h3>Error.</h3>
        <p>Serpentine error handler page</p>
      </div>
    </div>
  </div>
  ...
  <div class="row">    
    ...
    <div class="eight columns">
      ...
      <!-- Feed Entry -->
      <div class="row">
        <div class="one column"><i class="foundicon-error" style="font-size:28pt; color:red"></i></div>
    ...
    <div class="twelve columns">
      ...
      <div class="row">
        <div class="six columns">
          <p>The Serpentine open-source Python stack. New from Binary Machines. HTTP request handling by bottle. Forms by WTForms. Templates by Jinja2. ORM by SQLAlchemy. UI by Foundation.</p>
        </div>
        <div class="six columns">
